(() => {
  ...
  const PRICE_URL = "https://raw.githubusercontent.com/komimsp/msp2_json_ids/main/prices/id_cena.json";
  ...
  function setBadge(badge, text, typeClass) {
    ...
    badge.classList.add(typeClass || "unknown");
